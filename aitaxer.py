...
image_free1 = Image.open('H:\\Pythonprojects\\aitax\\venv\\images\\picture_free.jpg')
...
with st.sidebar:
    ...
    st.markdown("## [9. Модель Формула Саэса](#saez)", unsafe_allow_html=True)
...
st.write('* 3) Методика Эммануэля Саэса [Emmanual Saez](https://eml.berkeley.edu/~saez/Saez_photopage_8_1.html).')
...
st.header('Модель Эммануэля Саэса (Emmanuel Saez)', anchor='saez')
...
st.write('Эммануэль Саэс - французский и американский экономист, специалист по налоговой политике и неравенству. '
...
formula1 = st.radio('Каким образом расчитывается налог?', ('Свободный рынок','Налог согласно US Federal','Формула Эммануэля Саэса','AI tax планировщик'))
